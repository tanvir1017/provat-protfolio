  ...
  return (
    <div className="container isolate z-0 min-h-[40.5dvh] lg-min:min-h-[57.5dvh] grid place-content-center lg-min:pt-36 pt-[200px]">
      <div className="grid place-items-center gap-y-6">
        <h1 className="inline-block font-medium text-center lg-min:leading-[6rem] leading-[3rem] text-[2.75rem] lg-min:text-[5.75rem] max-w-full lg-min:max-w-3xl hero__text">
